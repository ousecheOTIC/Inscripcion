...
public class Login2 {
    ...
    */
    ...
    @Test(priority = 5)
    public void levantarExloradorArchivos () throws Exception {
        // Especifica la carpeta en la que deseas buscar
        String directorioBusqueda = "C:\\Users\\ouseche\\OneDrive - OTIC CChC\\Escritorio\\Automatización\\probando";
        ...
        Thread.sleep(10000);
        modificarArchivoExcel(nombreArchivoBuscado);
    }

    private static void modificarArchivoExcel(String rutaArchivo) throws Exception {
        // Abre el archivo Excel
        try (FileInputStream fis = new FileInputStream(rutaArchivo);
             Workbook workbook = new XSSFWorkbook(fis)) {

            // Selecciona la hoja de trabajo (puedes cambiar el índice según tus necesidades)
            Sheet sheet = workbook.getSheetAt(0);

            // Obtén la fila y la celda que deseas modificar (puedes cambiar los índices según tus necesidades)
            Row row = sheet.getRow(0);
            Cell cell = row.getCell(0);

            // Modifica el valor de la celda
            cell.setCellValue("Nuevo Valor");
            ...
            System.out.println("Archivo Excel modificado con éxito.");
        }
    }
