...
*/
        ...
        if (txtEtapa.contains("Tipo de Curso")) {
            ...
            if (ListLineas.size() == 2 || ListLineas.size() == 5) {
                ...
                if (tipolinea.contains("1")) {
                    ...
                    this.curso_cuenta2 = extraerDatosDeLinea(rutaArchivo,34);
    ...
    private void crearCurso() throws InterruptedException, IOException {
        ...
        String rut_NombreDeCursoNuevo = extraerDatosDeLinea(rutaArchivo,33);
...
*/
    ...
    public void ValorAcordadoParticipante() throws InterruptedException, IOException {
        ...
        //Buscamos el nombre del curso en el archivo de DATOS PRUEBAS
        valorAcordado = extraerDatosDeLinea(rutaArchivo, 19);
    ...
    */
    ...
    public void IngresoHoraInicioYHoraTermino() throws InterruptedException, IOException {
        ...
        this.horaInicio = extraerDatosDeLinea(rutaArchivo, 22);
        this.horaTermino = extraerDatosDeLinea(rutaArchivo, 23);
    ...
    public void seleccionarHorario_Comentarios() throws InterruptedException, IOException {
       ...
       WebElement parcial_Complementario = null;
        try {
            ...
            this.horaParcial = extraerDatosDeLinea(rutaArchivo,26);
            ...
            this.comentario= extraerDatosDeLinea(rutaArchivo,30);
...
//2. Si posteriormente le da clic en salir, regresara a la pantalla principal del paso 4,  se mostrara qu
    ...
    public void InscribirCurso() throws InterruptedException, IOException {
        ...
        btnInscribir.click();
        Thread.sleep(25000);//Espera necesaria para que cargue la pagina despues de inscribir curso
    ...
    public void descargarArchivos() throws InterruptedException, IOException{
        ...
        for (WebElement sc: solicitudesParaDescargar){
            ...
            WebElement btnDescargar = sc.findElement(By.className("//button[contains(text(), 'Descargar')]"));
            btnDescargar.click();
    ...
    public void seleccionarDireccion_CursoPresencial () throws InterruptedException, IOException {
        ...
        while (regionIngresada==false && comunaIngresada==false){
            ...
            this.regionCurso = extraerDatosDeLinea(rutaArchivo,27);
            this.comunaCurso = extraerDatosDeLinea(rutaArchivo,28);
            this.direccionCursoPresencial= extraerDatosDeLinea(rutaArchivo,29);
            try {
