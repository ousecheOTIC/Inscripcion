...
public class Dashboard extends Login2 {
    ...
    */
    ...
    public void botonGraficos () throws InterruptedException, IOException {
        ...
        String msjBoton= btnGraficos.getText();
        //System.out.printf("El boton dice: "+msjBoton);
    ...
    private void buscadorDeCursos(String tipoDeBuscador, String elementoBusqueda) throws InterruptedException, IOException {
        ...
        //System.out.println(tipoDeBuscador);
        // Localiza todos los elementos por su clase
        ...
        if (buscador.size()==3) {
            ...
            //Presionamos Buscar
            WebElement btnBuscar = wait.until(ExpectedConditions.elementToBeClickable(By.className("drFfTY")));
            btnBuscar.click();
            ////////////////////////////////////////////////////////////////////////////////////////////////////////////////

            //System.out.println("La variable trae: " + tipoDeBuscador);
